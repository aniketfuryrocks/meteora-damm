...
impl Pool {
    ...
    pub fn is_swap_enabled(&self, clock: &Clock) -> bool {
        let activation_type = ActivationType::try_from(self.bootstrapping.activation_type).unwrap();
        ...
        current_point >= self.bootstrapping.activation_point
    }
}
